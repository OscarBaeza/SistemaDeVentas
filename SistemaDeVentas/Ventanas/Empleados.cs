    ...
    public partial class Empleados : Form
    {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            if (cont == 9)
            {
                ...
                agregar.ApellidoPaterno = txtApePat.Text;
                agregar.ApellidoMaterno = txtApeMat.Text;
                agregar.Email = txtMail.Text;
                agregar.password = txtpass.Text;
                agregar.Encargado = Convert.ToInt32(txtencargado.Text);
                agregar.Date = txtFecha.Text;
                agregar.Direccion = txtDirec.Text;
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (dtgvEmpleados.SelectedRows.Count == 1)
            {
                ...
                String apellidoPaterno = txtApePat.Text;
                String apellidoMaterno = txtApeMat.Text;
        ...
        private void MostrarDatos(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtApePat.Text = Convert.ToString(dtgvEmpleados.CurrentRow.Cells[2].Value);
            txtApeMat.Text = Convert.ToString(dtgvEmpleados.CurrentRow.Cells[3].Value);
            txtMail.Text = Convert.ToString(dtgvEmpleados.CurrentRow.Cells[4].Value);
            txtpass.Text = Convert.ToString(dtgvEmpleados.CurrentRow.Cells[5].Value);
            ...
            txtDirec.Text = Convert.ToString(dtgvEmpleados.CurrentRow.Cells[8].Value);
